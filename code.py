...
# (red, green, blue) -- enter percentages (0-100) note lights are not the same brightness white is (30, 70, 100)
BUTTON_COLOR = (30, 70, 100)
...
red_led = pwmio.PWMOut(board.D11)
green_led = pwmio.PWMOut(board.D12)
blue_led = pwmio.PWMOut(board.D13)
...
while True:
    ...
    red_led.duty_cycle = duty_cycle(BUTTON_COLOR[0])
    green_led.duty_cycle = duty_cycle(BUTTON_COLOR[1])
    blue_led.duty_cycle = duty_cycle(BUTTON_COLOR[2])  
